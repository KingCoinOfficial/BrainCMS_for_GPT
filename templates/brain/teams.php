			...
			{	
				...
				if ($getMembers->RowCount() > 0)
				{
					while ($member = $getMembers->fetch())
					{
						...
						<div id="column" style="border: 2px dotted rgba(0, 0, 0, 0.2);margin-top: -10px;margin-left: 10px;margin-right: 10px;margin-bottom: 10px;float: left;height:55px;width: 55px;border-radius: 555px;-moz-border-radius: 555px;-webkit-border-radius: 555px;background:url('.$config['habboImagingUrl'].''.$look.'&head_direction=3&amp;action=wav) no-repeat;background-position: 50% 10%;"></div>

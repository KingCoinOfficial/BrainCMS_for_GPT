		...
		<div class="box">
			...
			<div class="mainBox" style="float;left">
				...
				<form action="" method="POST">
					...
					<p><label><b style='font-family: verdana'>Discord:</b><br>
					<input type="text" name="skype" size="400" placeholder="Discord" value= "" id="username" style="width: 100%;"></p>
		            ...
		            <option name="functie" value="Lubba X">Lubba X</option>
					<option name="functie" value="Moderator">Moderator</option>
					<option name="functie" value="Administrator">Administrator</option>
					<option name="functie" value="Techniker">Techniker</option>

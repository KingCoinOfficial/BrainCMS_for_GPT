<body style="background: #3498db;">
	<html>
		...
		<body >
			...
			<div id="PINcode">
				<center>
					<img style="padding-top:100px;" src="/templates/brain/style/images/logo/logo.png"></img>
				</center>
			</div>
			<script src="/templates/brain/style/js/jquery.min.js" type="text/javascript"></script>
			
			<form name='PINform' id='PINform' method="post"><center><?= $lang["staffPin"] ?></center>
				...
				<center><p> Copyright &copy; 2023 - Swiss Retro Industry</p></center>
			</form>
			<script>

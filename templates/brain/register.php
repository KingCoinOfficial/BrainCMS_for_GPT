...
<html>
	<head>
		...
		<title><?= $config['hotelName'] ?>: <?= $config['sitetitle'] ?></title>
		<link href="/templates/brain/bootstrap/css/bootstrap.css" rel="stylesheet" type="text/css"><!--Bootstrap 5-->
		<!--<link href="/templates/brain/bootstrap2/css/bootstrap.css" rel="stylesheet" type="text/css">-->
		<!--<link href="/templates/brain/bootstrap3/css/bootstrap.css" rel="stylesheet" type="text/css">-->
		<!--<link href="/templates/brain/bootstrap4/css/bootstrap.css" rel="stylesheet" type="text/css">-->
						...
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-lg-8">
									...
									<p>Wurdest du von einem <?= $config['hotelName'] ?> eingeladen?</p>
									<i class="glyphicon glyphicon-tag form-control-feedback" style="right: 10px;"></i>
								</div>
							</div>
							<div class="form-group" style="margin-top:20px;">
							<p>Erstelle dein <?= $config['hotelName'] ?> Avatar</p>
								<div style="width: 0%;" class="col-lg-8">
									...
									<div id="avatarSelector" class="builder-viewport" style="margin-top: -45px;">
										...
										<div id="avatar">
											<img id="myHabbo" value="" src="" alt="My Habbo" title="Mein Lubba" />
							...
							<div class="form-group" style="text-align: right;margin-top:60px;">
								<div class="col-lg-8 col-lg-offset-4">
									<a href="/index" class="btn btn-info"><?php echo $lang['Rback']; ?></a>
									<button type="submit" name="register" id="registerSubmit" class="btn btn-success"><?php echo $lang['Rregister']; ?></button>

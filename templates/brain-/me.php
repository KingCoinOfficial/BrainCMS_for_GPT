		...
		<div class="boxuser">
			<div class="userplate">
				...
				<div class="useravatar">
					<div class="avatar" style="background-image:url(https://retroripper.com/habbo-imaging/avatarimage?figure=<?= User::userData('look') ?>&amp;direction=2&amp;head_direction=3&amp;action=crr=667&amp;gesture=sml);"></div>
				</div>
			</div>
			<div class="userfirst">

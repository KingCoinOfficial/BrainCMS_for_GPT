		...
		<div class="boxuser">
			<div class="userplate">
				...
				<div class="useravatar">
					<div class="avatar" style="background-image:url(https://www.habbo.com/habbo-imaging/avatarimage?figure=<?= User::userData('look') ?>&amp;direction=2&amp;head_direction=3&amp;action=crr=667&amp;gesture=sml);"></div>
				</div>
			</div>
			<div class="userfirst">
			...
			<div class="mainBox" style="float;left">
				<?php
					...
					<div class="userNewBox">
						<a href="/home/<?= filter($getUsersDev['username']) ?>"><div class="userNew" style="background: url(https://www.habbo.com/habbo-imaging/avatarimage?figure=<?= filter($getUsersDev['look']) ?>&direction=3&head_direction=3&action=wav&headonly=0); background-position: 15px 2px;width: 80px;float: left;background-repeat: no-repeat;"></div>
		...
		<div class="columright">
			...
			<div class="box">
				...
				<div class="mainBox" style="float;left">
					...
					<audio autoplay controls volume="50%" preload="none">
	<source src="http://icepool.silvacast.com/DEFJAY.mp3" type="audio/ogg">
	<source src="http://icepool.silvacast.com/DEFJAY.mp3" type="audio/mpeg">
</audio>

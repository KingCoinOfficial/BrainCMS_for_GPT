				...
				<div class="box">
					...
					<div class="mainBox" style="float;left">
						<div class="userlooknow">
							<div class="avatar" style="width: 120px;height: 242px; background-image: url(https://www.habbo.com/habbo-imaging/avatarimage?head_direction=2&direction=2&size=l&figure=<?= User::userData('look') ?>);"></div>
						</div>
					</div>
				</div>
			</div>
							...
							<?php 
								...
								if ($getUserLook->RowCount() > 0)
								{
									while ($getUserLookData = $getUserLook->fetch())
									{
										...
										<div class= "userLookAvatarlook" style="background-image: url(https://www.habbo.com/habbo-imaging/avatarimage?head_direction=4&direction=4&size=m&figure='.$getUserLookData['look'].');"></div>
										</a>

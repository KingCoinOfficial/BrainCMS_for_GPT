...
<?php
	...
	<div style="width: 500px; margin-left: 0px;" class="columright">
				...
				<div id="column" style="    width: 460px;height: 400px;background: url('/templates/brain/style/images/icons/Hotel_HP_BG.png') no-repeat;background-color: #FFF;">
					<div class='boxbg1'>
						<div class="platte" style="float: left;margin-left:-5px;margin-top:5px;width:119px;height:165px">
							<img src="https://www.habbo.com/habbo-imaging/avatarimage?figure=<?= userHome('look'); ?>&direction=2&head_direction=3&action=wlk&gesture=sml" style="-webkit-filter: drop-shadow(0 1px 0 #FFFFFF) drop-shadow(0 -1px 0 #FFFFFF) drop-shadow(1px 0 0 #FFFFFF) drop-shadow(-1px 0 0 #FFFFFF);margin-top: -20px;position: absolute;margin-left: 25px;">
						</div>
		...
		<div class="box">
			<div class="title blue">Beziehungsstatus von <?= userHome('username'); ?></div>
			<div class="mainBox" style="float;left">
		...
		<div class="box">
			...
			<div class="mainBox" style="float;left">
				<?php
					...
					{
						echo userHome('username').' hat keine Badges!';
					}
				?>
			</div>
		</div>
					...
					<?php
						...
						if (!$sql->RowCount() == 0)
						{
							while($news = $sql->fetch())
							{
								...
								echo'
								<a href="/home/'.filter($getUserData['username']).'"> <img style="float: right;" src="https://www.habbo.com/habbo-imaging/avatarimage?figure='.filter($getUserData['look']).'&direction=3&head_direction=3&action=wav&gesture=sml&size=s&headonly=0"> 
						...
						{
							echo userHome('username').' hat keine Freunde!';
						}
					?>
				</div>
			</div>

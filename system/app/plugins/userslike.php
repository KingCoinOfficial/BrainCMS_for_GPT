	...
	function userlike($id)
	{
		if (loggedIn())
		{
			...
			if ($config['userLikeEnable'] == true)
			{
				...
				echo'<b><font size="5px">(</font><font size="5px;" color="#00C103">';
				echo $row['user_likes'];
				echo '</font><font size="5px">)</font></b>'.$likeurl.' <img style="zoom: 110%;" src="'.$config['hotelUrl'].'/templates/'.$config['skin'].'/weed_images/icons/'.$userlikedIcon.'.png"></a>';
